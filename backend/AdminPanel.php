...
class AdminPanel
{
    ...
    // when the object is created it initially checks for authentication if the session is set(when logged in), in that case only the access to the page is given otherwise the access is revoked and redirected to login page
    public function __construct($connection)
    {
        $this->connection = $connection;
        $this->checkAuth();
    }
    // the function checks whether the user is logged in or not using session
    ...
    // the function to logout, by unsetting and destroying the session
    ...
    // the function to fetch all the bus services
    ...
    // function to render nav tag and its content
...
HTML;
    ...
    // function to render the station master card
...
HTML;
    ...
    // function to update the password of station master
    ...
    // function to render to new bus input form
    ...
    // function to get the data of a new bus to the database
